...
fn f16_to_f32(h: u16) -> f32 {
    ...
    let bits = if exp == 0 {
        ...
        // `exp` is unsigned. Writing the C expression as `exp - 15 + 127`
        // underflows in Rust for valid f16 exponents 1..=14 in debug builds.
        // Reassociate the mathematically identical bias adjustment instead.
